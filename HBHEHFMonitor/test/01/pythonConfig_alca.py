...
#Viewmuon=cms.untracked.InputTag("muons"),    #remove for alca Yildiray
...
#PFMetCollection=cms.InputTag("pfMet","", "RECO"),     #remove for alca Yildiray
#PFJetCollection=cms.untracked.InputTag("jetLabelx"),  #remove for alca Yildiray
#PFJetCollection=cms.InputTag("ak4PFJets","","RECO"),  #remove for alca Yildiray
...
#process.p1 = cms.Path(process.noscraping)  #remove for alca Yildiray
#process.p2 = cms.Path(process.HBHENoiseFilterResultProducer*process.ApplyBaselineHBHENoiseFilter)  #remove for alca Yildiray
...
#process.p7 = cms.Path(process.trackingFailureFilter)   #remove for alca Yildiray
#process.p8 = cms.Path(process.eeBadScFilter)           #remove for alca Yildiray
#process.p9 = cms.Path(process.ApplyBaselineHBHENoiseFilter25nsloose)  #remove for alca Yildiray
#process.p10 = cms.Path(process.ApplyBaselineHBHENoiseFilter25nstight) #remove for alca Yildiray
